...
export const COUNTRIES: Country[] = [
  ...
  { code: "MY", name: "Malaysia", region: "Asia", flag: "🇲🇾", currency: "MYR" },
  { code: "PH", name: "Philippines", region: "Asia", flag: "🇵🇭", currency: "PHP" },
  { code: "BD", name: "Bangladesh", region: "Asia", flag: "🇧🇩", currency: "BDT" },
  { code: "LK", name: "Sri Lanka", region: "Asia", flag: "🇱🇰", currency: "LKR" },
  { code: "KZ", name: "Kazakhstan", region: "Asia", flag: "🇰🇿", currency: "KZT" },
  { code: "TW", name: "Taiwan", region: "Asia", flag: "🇹🇼", currency: "TWD" },
  { code: "BE", name: "Belgium", region: "Europe", flag: "🇧🇪", currency: "EUR" },
  { code: "AT", name: "Austria", region: "Europe", flag: "🇦🇹", currency: "EUR" },
  { code: "IE", name: "Ireland", region: "Europe", flag: "🇮🇪", currency: "EUR" },
  { code: "PT", name: "Portugal", region: "Europe", flag: "🇵🇹", currency: "EUR" },
  { code: "DK", name: "Denmark", region: "Europe", flag: "🇩🇰", currency: "DKK" },
  { code: "FI", name: "Finland", region: "Europe", flag: "🇫🇮", currency: "EUR" },
  { code: "CZ", name: "Czechia", region: "Europe", flag: "🇨🇿", currency: "CZK" },
  { code: "GR", name: "Greece", region: "Europe", flag: "🇬🇷", currency: "EUR" },
  { code: "HU", name: "Hungary", region: "Europe", flag: "🇭🇺", currency: "HUF" },
  { code: "RO", name: "Romania", region: "Europe", flag: "🇷🇴", currency: "RON" },
