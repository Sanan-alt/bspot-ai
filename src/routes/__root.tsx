...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "BSpot AI" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "BSpot AI — Move Capital. Cross Borders. Build Empires." },
      { name: "twitter:description", content: "Live markets, real country intelligence, and AI roadmaps for investing across borders." },
    ],
    links: [
    ...
    scripts: [
      {
        async: true,
        "data-cfasync": "false",
        src: "https://pl30818823.effectivecpmnetwork.com/088810e9f081dad6c6faf5198a417989/invoke.js",
      } as any,
      {
