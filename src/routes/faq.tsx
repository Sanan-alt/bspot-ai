...
const faqs = [
  ...
  { q: "Can I delete my account and data?", a: "Yes — from Settings → Account, or by emailing privacy@bspot-ai.lovable.app. We remove your profile, documents, and history within 30 days." },
...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://bspot-ai.lovable.app/faq" },
    ],
    links: [{ rel: "canonical", href: "https://bspot-ai.lovable.app/faq" }],
    scripts: [
      {
  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <Accordion type="single" collapsible className="mt-10 panel divide-y divide-border">
          {faqs.map((f, i) => (
            <AccordionItem key={i} value={`q-${i}`} className="px-5">
              <AccordionTrigger className="text-left font-display text-lg hover:text-neon">{f.q}</AccordionTrigger>
